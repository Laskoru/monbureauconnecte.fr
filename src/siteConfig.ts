...
export const siteConfig = {
  ...
  // Branding
  accentColor: '#c6f135', // lime Studio : surligneur et actions, jamais en texte sur fond clair
  ...
  social: {
    twitter: '',
    instagram: '',
    // URL complète du profil Pinterest (ex : 'https://www.pinterest.fr/monbureauconnecte/').
