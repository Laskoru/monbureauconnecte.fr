...
products:
  - asin: "B0CFZXBQP8"
    ...
    pros:
      ...
      - "Supporte la faible luminosité"
      - "Bon premier choix de plante"
    cons:
      - "Croissance lente"
...
faq:
  ...
  - question: "Combien de temps faut-il consacrer à l'entretien d'une plante de bureau ?"
    answer: "Pour les espèces recommandées ici, très peu : un arrosage toutes les une à deux semaines suffit largement, et un oubli occasionnel ne les met pas en danger. Ce sont volontairement des plantes choisies pour leur tolérance, pas des variétés qui demandent une attention quotidienne."
---
