...
interactiveGuide:
  ...
  options:
    - label: "Des visios en solo (Teams, Zoom)"
      result: "Un micro <strong>cardioïde</strong> (qui capte surtout ce qui est en face) avec <strong>bouton muet physique</strong> est parfait. Pas besoin d'un rendu studio : la priorité, c'est une voix nette et un mute rapide."
...
faq:
  ...
  - question: "Faut-il un bras articulé pour son micro ?"
    answer: "Ce n'est pas indispensable pour une simple visio, mais c'est très pratique : un bras articulé positionne le micro près de la bouche sans encombrer le bureau ni obliger à se pencher, et il isole des vibrations de la table. Pour du podcast ou un usage quotidien, c'est un vrai confort."
---
...
### Le type de captation

C'est le critère de fond. Un micro **cardioïde** capte surtout ce qui est **en face** de lui : idéal en solo, car il isole ta voix du bruit ambiant. Un micro **omnidirectionnel** capte tout autour : utile seulement si plusieurs personnes parlent autour du même micro. Choisir le mauvais type, c'est soit capter toute la pièce, soit oublier la moitié des voix d'une réunion.
...
Un micro trop bas oblige à se pencher ; un **bras articulé** le positionne près de la bouche sans encombrer le bureau, et il isole des vibrations de la table. Pour du podcast ou un usage quotidien intensif, c'est un vrai confort.
