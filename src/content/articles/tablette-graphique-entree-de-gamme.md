...
faq:
  ...
  - question: "Faut-il un écran intégré sur la tablette pour un usage bureau ?"
    answer: "Non, et c'est même déconseillé pour débuter. Les tablettes avec écran intégré coûtent nettement plus cher et demandent une habitude de dessiner « directement sur l'image », qui déroute au début. Une tablette sans écran, où l'on regarde son moniteur habituel pendant qu'on dessine sur la surface, est plus simple à prendre en main et largement suffisante pour de l'annotation ou de l'initiation au dessin numérique."
  - question: "Quelle taille de tablette graphique choisir pour un bureau ?"
    answer: "Un format compact (proche d'une petite tablette de note) suffit pour l'annotation, la signature et l'initiation au dessin. Une plus grande surface facilite les gestes amples utiles en illustration détaillée, mais prend plus de place sur le bureau et n'apporte rien de plus pour un usage occasionnel. Pour débuter, mieux vaut un format compact que l'on utilise réellement qu'un grand modèle qui finit rangé dans un tiroir."
---
