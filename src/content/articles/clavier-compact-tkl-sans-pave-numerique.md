...
faq:
  ...
  - question: "Le format TKL est-il compatible avec les raccourcis clavier habituels ?"
...
Sur un petit bureau, ou un poste partagé entre plusieurs usages (ordinateur pro, tablette, notes papier), les quelques centimètres récupérés permettent aussi de garder de la place pour un carnet ou un support téléphone, sans repousser l'écran vers le fond du plan de travail.

C'est aussi un choix qui a du sens pour qui travaille sur un support d'ordinateur portable surélevé : moins l'espace disponible devant l'écran est large, plus chaque centimètre gagné à droite du clavier compte pour garder une position naturelle du bras avec la souris. Beaucoup de gens découvrent le format TKL en changeant simplement d'avis sur ce dont ils ont réellement besoin : le pavé numérique, pensé à l'origine pour la saisie comptable intensive, ne sert quasiment jamais dans un usage bureautique courant fait de mails, de navigation web et de rédaction.
