...
interactiveGuide:
  ...
  options:
    - label: "En open space partagé"
      result: "Vise des switches <strong>linéaires silencieux (rouge silent)</strong> : pas d'à-coup tactile ni de clic, le profil le plus discret pour les voisins. Un <strong>format compact</strong> rapproche la souris en prime."
    - label: "Souvent en visio"
      result: "Priorité absolue au silence : le <strong>micro capte les clics</strong> bien plus que toi. Switches silent + un peu de distance entre le micro et le clavier, et fuis les switches <strong>clicky (bleus)</strong>."
    - label: "En bureau fermé, seul"
...
faq:
  ...
  - question: "Un clavier à membrane n'est-il pas plus silencieux qu'un mécanique ?"
    answer: "Souvent oui, un clavier à membrane basique est discret. Mais un mécanique à switches silencieux combine un bruit réduit ET un confort de frappe supérieur (course, précision, durabilité) que la membrane n'offre pas. Si le silence seul compte et que le budget est serré, la membrane suffit ; si tu veux le confort mécanique sans le vacarme, le mécanique silencieux est fait pour ça."
---
...
- **Le format** : un modèle **compact** (sans pavé numérique) libère de la place pour la souris. Voir notre guide [clavier compact TKL](/articles/clavier-compact-tkl-sans-pave-numerique/).
...
> Les références et les prix bougent souvent. Pour voir ce qui est disponible aujourd'hui : [voir les claviers mécaniques silencieux sur Amazon](https://www.amazon.fr/s?k=clavier+mecanique+silencieux&tag=monbureauconnecte-21).

## Quel profil de switch selon l'environnement

| Environnement | Switch conseillé | À éviter |
| --- | --- | --- |
| **Open space** | Linéaire silent (rouge) | Clicky (bleu) |
| **Visio fréquente** | Linéaire silent | Clicky, tactile bruyant |
| **Bureau fermé** | Tactile brun silencieux | — (plus de liberté) |
