...
const HASHTAGS_BY_CATEGORY = {
  mobilier: ['#bureauergonomique', '#teletravail', '#homeoffice'],
  peripheriques: ['#setupgaming', '#gadgets', '#teletravail'],
  'audio-visio': ['#teletravail', '#visioconference', '#homeoffice'],
};
...
1. Plan large du problème / de la situation avant (ex. mauvaise posture, bureau encombré, matériel générique)
